...
OUT = os.path.join(HERE, "fyw-syllabus.html")
...
proposal = item("Research Proposal (Midterm Assignment) &mdash; 30%",
  ...
  '<p>By Friday 10/16, you will compile your background, methodology, and significance sections together with the new abstract into a single, complete first draft of your proposal. <a href="https://docs.google.com/document/d/1ks_4K9tp-IavWVyWzq5TCJxC9bo6g5WJ4TbqjuJS0D8/edit?usp=sharing">Click here for full assignment details</a>.</p>'
